...
public abstract class BaseGameServerRegister
{
	...
	private static void printHelp(ResourceBundle bundle)
	{
		String[] help =
		{
			...
			bundle.getString("bugReports") + " http://www.L2GamePlay.com"
			 ...
			 * "-u, --unregister <id>|all\t\tRemoves GameServer denoted by <id>, use \"all\" for removing all registered GameServers", "", "Copyright (C) L2GP Team 2008-2012.", "Report bugs: http://www.L2GamePlay.com"
			 */
		};
